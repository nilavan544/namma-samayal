...
export default function App() {
  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      try {
        const edamamRes = await fetch(`https://api.edamam.com/api/recipes/v2?type=public&q=${encodeURIComponent(searchTerm)}&app_id=YOUR_APP_ID&app_key=YOUR_APP_KEY&to=20`)
      ...
      // 3. TheMealDB (300 recipes, backup)
